...
export const CATEGORIES = [
  { id: 'electronics', label: 'Electronics', icon: 'electronics', color: '#3b82f6' },
  { id: 'chemicals', label: 'Chemicals', icon: 'chemicals', color: '#10b981' },
  { id: 'physics', label: 'Physics', icon: 'physics', color: '#8b5cf6' },
  { id: 'biology', label: 'Biology', icon: 'biology', color: '#ec4899' },
  { id: 'coding', label: 'Coding', icon: 'coding', color: '#f59e0b' },
  { id: 'mathematics', label: 'Mathematics', icon: 'mathematics', color: '#ef4444' },
  { id: 'thermodynamics', label: 'Thermodynamics', icon: 'thermodynamics', color: '#06b6d4' },
  { id: 'optics', label: 'Optics', icon: 'optics', color: '#a855f7' },
  { id: 'quantum', label: 'Quantum', icon: 'quantum', color: '#14b8a6' },
  { id: 'mechanics', label: 'Mechanics', icon: 'mechanics', color: '#6366f1' },
  { id: 'astronomy', label: 'Astronomy', icon: 'astronomy', color: '#818cf8' },
  { id: 'geology', label: 'Geology', icon: 'geology', color: '#b45309' },
  { id: 'music', label: 'Music & Audio', icon: 'music', color: '#db2777' },
  { id: 'robotics', label: 'Robotics', icon: 'robotics', color: '#4b5563' },
  { id: 'ai_ml', label: 'AI & ML', icon: 'ai_ml', color: '#7c3aed' },
];
